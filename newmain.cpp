...
int main(int argc, char** argv) {
    ...
    Vertice* v1=a.insertarVertice("jose", 1);
    b.insertarUbicacion(v1);
    cout<<v1->getNombre()<<endl;
    
    Vertice* v2=a.insertarVertice("mauren", 2);
    b.insertarUbicacion(v2);
    cout<<v2->getNombre()<<endl;
    
    Vertice* v3=a.insertarVertice("Sulli", 3);
    b.insertarUbicacion(v3);
    cout<<v3->getNombre()<<endl;
    
   Vertice* v4=a.insertarVertice("TorresGemelas", 4);
    b.insertarUbicacion(v4);
    cout<<v4->getNombre()<<endl;
    
    Vertice* v5=a.insertarVertice("ucenfotec", 5);
    b.insertarUbicacion(v5);
    cout<<v5->getNombre()<<endl;
    
    Vertice* v6=a.insertarVertice("ratas de purral", 6);
